  ...
  return (
    <footer className="mt-24 border-t border-warmGray">
      <div className="container-page grid grid-cols-1 gap-10 py-12 md:grid-cols-3">
        <div>
          <div className="mono mb-3 text-[13px] uppercase tracking-[0.22em] text-muted">Eduba</div>
        ...
        <div>
          <div className="mono mb-3 text-[13px] uppercase tracking-[0.22em] text-muted">The Platform</div>
        ...
        <div>
          <div className="mono mb-3 text-[13px] uppercase tracking-[0.22em] text-muted">Legal</div>
          <ul className="space-y-1.5 text-sm">
